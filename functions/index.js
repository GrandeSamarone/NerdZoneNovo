...
exports.chat =
    functions.database.ref('/conto/{pushid}/mensagem')
...
function emojifyText(text) {
    ...
    emojifiedText = emojifiedText.replace(/\blol\b/ig, "seu merda");
    emojifiedText = emojifiedText.replace(/\bcat\b/ig, "peidei");
	 emojifiedText = emojifiedText.replace(/\bconto\b/ig, "marlos");
