...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Adapter_resultado.Adapter_resultado_loja_virtual;
...
public class Resultado_loja_virtual extends AppCompatActivity {

    private Toolbar toolbar;
    private FloatingActionButton novo_influencer;
    private FirebaseUser usuario;
    private Adapter_resultado_loja_virtual adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_loja_virtual);
        ...
        mDatabase_digital = ConfiguracaoFirebase.getFirebaseDatabase()
                .child("votacao").child("categorias").child("loja_virtual").orderByChild("votos");
        //recycleview
        recyclerViewresultado = findViewById(R.id.resultado_loja_virtual);
        //recyclerViewresultado.setHasFixedSize(true);
        mManager = new LinearLayoutManager(this);
        mManager.setReverseLayout(true);
        mManager.setStackFromEnd(true);
        recyclerViewresultado.setLayoutManager(mManager);
        adapter = new Adapter_resultado_loja_virtual(this, lista_digital_influence);
...
*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                Intent it = new Intent(Resultado_loja_virtual.this, Lista_portal_noticia.class);
                startActivity(it);
                finish();
                break;
    ...
    private void tela_finalizar() {
        android.app.AlertDialog.Builder msgbox = new android.app.AlertDialog.Builder(Resultado_loja_virtual.this);
        ...
        msgbox.setPositiveButton("Sim",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int wich) {
                        Intent it = new Intent(Resultado_loja_virtual.this, Lista_loja_vitural.class);
                        startActivity(it);
                        finish();
                    }
