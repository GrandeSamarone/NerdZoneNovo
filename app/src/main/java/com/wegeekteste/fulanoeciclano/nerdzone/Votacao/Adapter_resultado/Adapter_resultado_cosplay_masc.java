...
public class Adapter_resultado_cosplay_masc extends RecyclerView.Adapter<Adapter_resultado_cosplay_masc.MyViewHolder> {

    private ArrayList<Categoria_cosplay_masc> lista_digital;
    private Context context;

    public Adapter_resultado_cosplay_masc(Context c, ArrayList<Categoria_cosplay_masc> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_cosplay_masc> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_cosplay_masc getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_cosplay_masc categoria_pessoa = lista_digital.get(position);
