...
public class Adapter_reporter_masc extends RecyclerView.Adapter<Adapter_reporter_masc.MyViewHolder> {

    private ArrayList<Categoria_reporter_masc> lista_digital;
    private Context context;

    public Adapter_reporter_masc(Context c, ArrayList<Categoria_reporter_masc> categora){
        this.context=c;
