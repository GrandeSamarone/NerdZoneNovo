...
public class Adapter_resultado_espaco_geek extends RecyclerView.Adapter<Adapter_resultado_espaco_geek.MyViewHolder> {

    private ArrayList<Categoria_espaco_geek> lista_digital;
    private Context context;

    public Adapter_resultado_espaco_geek(Context c, ArrayList<Categoria_espaco_geek> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_espaco_geek> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_espaco_geek getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_espaco_geek categoria_pessoa = lista_digital.get(position);
