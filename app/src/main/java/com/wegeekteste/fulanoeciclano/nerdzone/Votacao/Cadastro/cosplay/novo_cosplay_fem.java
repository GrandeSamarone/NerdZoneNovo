...
public class novo_cosplay_fem extends AppCompatActivity implements View.OnClickListener {
    ...
    private Categoria_cosplay_fem digital;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_novo_cosplay_fem);

        toolbar = findViewById(R.id.toolbarsecundario_sem_foto);
        toolbar.setTitle("Novo Cosplayer Fem");
        setSupportActionBar(toolbar);

        //Configuração Basica
        campotitulo = findViewById(R.id.nome_digital_cosplay_fem);
        campodesc = findViewById(R.id.desc_digital_cosplay_fem);
        campocontato = findViewById(R.id.desc_contato_cosplay_fem);
        imagem1 = findViewById(R.id.imageLojaCadastro_cosplay_f1);
        imagem1.setOnClickListener(this);
        imagem2 =findViewById(R.id.imageLojaCadastro_cosplay_f2);
        imagem2.setOnClickListener(this);
        imagem3 = findViewById(R.id.imageLojaCadastro_cosplay_f3);
        imagem3.setOnClickListener(this);
        imagem4 = findViewById(R.id.imageLojaCadastro_cosplay_f4);
        imagem4.setOnClickListener(this);
        imagem5 = findViewById(R.id.imageLojaCadastro_cosplay_f5);
        imagem5.setOnClickListener(this);
        imagem6 = findViewById(R.id.imageLojaCadastro_cosplay_f6);
        ...
        botaosalvar = findViewById(R.id.botaosalvar_cosplay_fem);
    ...
    public void  Salvar_Digital_Influence(){
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(novo_cosplay_fem.this);
                ...
                taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        if(totalfotos==listaURLFotos.size()){
                            ...
                            digital.Salvar();
                            dialog.dismiss();
                            Toast toast = Toast.makeText(novo_cosplay_fem.this, "Cadastrado com sucesso!", Toast.LENGTH_SHORT);
                            toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                            toast.show();
                            Intent it = new Intent(novo_cosplay_fem.this,Lista_cosplay_Femi.class);
                            startActivity(it);
                            finish();
                        }
                    }
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        dialog.dismiss();
                        Toast.makeText(novo_cosplay_fem.this, "Erro ao cadastrar", Toast.LENGTH_SHORT).show();
    ...
    private Categoria_cosplay_fem configurar_categoria_influence(){
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case  R.id.imageLojaCadastro_cosplay_f1:
                EscolherImagem(1);
                break;
            case  R.id.imageLojaCadastro_cosplay_f2:
                EscolherImagem(2);
                break;
            case  R.id.imageLojaCadastro_cosplay_f3:
                EscolherImagem(3);
                break;
            case  R.id.imageLojaCadastro_cosplay_f4:
                EscolherImagem(4);
                break;
            case  R.id.imageLojaCadastro_cosplay_f5:
                EscolherImagem(5);
                break;
            case  R.id.imageLojaCadastro_cosplay_f6:
                EscolherImagem(6);
                break;

            case R.id.botaosalvar_cosplay_fem:
                validarDados();
                break;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                Intent it = new Intent(novo_cosplay_fem.this, Lista_digital_fem.class);
                startActivity(it);
