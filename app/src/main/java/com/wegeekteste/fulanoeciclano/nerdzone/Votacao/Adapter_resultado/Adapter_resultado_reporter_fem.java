...
public class Adapter_resultado_reporter_fem extends RecyclerView.Adapter<Adapter_resultado_reporter_fem.MyViewHolder> {

    private ArrayList<Categoria_reporter_fem> lista_digital;
    private Context context;

    public Adapter_resultado_reporter_fem(Context c, ArrayList<Categoria_reporter_fem> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_reporter_fem> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_reporter_fem getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_reporter_fem categoria_pessoa = lista_digital.get(position);
