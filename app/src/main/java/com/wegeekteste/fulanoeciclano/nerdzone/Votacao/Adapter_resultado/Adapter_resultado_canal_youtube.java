...
public class Adapter_resultado_canal_youtube extends RecyclerView.Adapter<Adapter_resultado_canal_youtube.MyViewHolder> {

    private ArrayList<Categoria_youtube> lista_digital;
    private Context context;

    public Adapter_resultado_canal_youtube(Context c, ArrayList<Categoria_youtube> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_youtube> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_youtube getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_youtube categoria_pessoa = lista_digital.get(position);
