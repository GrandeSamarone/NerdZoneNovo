package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Listar.escritor_roterista;
...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Adapter_votacao.Adapter_escritor_masc;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.escritor_roterista.novo_escritor_masc;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Detalhe.Detalhe_escritor_roterista;
...
public class Lista_escritor extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private Adapter_escritor_masc adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_escritor);

        toolbar = findViewById(R.id.toolbarsecundario);
        toolbar.setTitle("Escritor/Roterista");
        setSupportActionBar(toolbar);

        //Configuracoes Originais
        linear_nada_cadastrado=findViewById(R.id.linear_nada_cadastrado_escritor);
        novo_influencer = findViewById(R.id.buton_novo_escritor);
        novo_influencer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent( Lista_escritor.this,novo_escritor_masc.class);
                startActivity(it);
                finish();
            }
        });
        ...
        refresh = findViewById(R.id.refresh_escritor);
        ...
        recyclerView_lista_digital = findViewById(R.id.recycleview_escritor);
        ...
        adapter = new Adapter_escritor_masc(this,lista_digital_influence);
        ...
        recyclerView_lista_digital.addOnItemTouchListener(new RecyclerItemClickListener(this,
            ...
            public void onItemClick(View view, int position) {
                List<Categoria_escritor_masc> listCategoriaAtualizado = adapter.getcategoria();

                if (listCategoriaAtualizado.size() > 0) {
                    Categoria_escritor_masc categoriaselecionada = listCategoriaAtualizado.get(position);
                    Intent it = new Intent(Lista_escritor.this,Detalhe_escritor_roterista.class);
        ...
        ChildEventListenerperfil=database_usuario.orderByChild("id").equalTo(identificadorUsuario).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                icone.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent it = new Intent(Lista_escritor.this, MinhaConta.class);
                        startActivity(it);

                    }
                });
                Glide.with(Lista_escritor.this)
                        .load(iconeurl)
                        .into(icone);
