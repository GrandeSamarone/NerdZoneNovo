package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Listar.empreendedor;
...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Adapter_votacao.Adapter_empreendedor;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.empreendedor.novo_empreendedor_masc;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Detalhe.Detalhe_empreendedor;
...
public class Lista_empreendedor extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private Adapter_empreendedor adapter;
    ...
    private ArrayList<Categoria_empreendedor> lista_digital_influence = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        novo_influencer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent( Lista_empreendedor.this,novo_empreendedor_masc.class);
                startActivity(it);
                finish();
            }
        });
        ...
        refresh = findViewById(R.id.refresh_empreendedor);
        ...
        recyclerView_lista_digital = findViewById(R.id.recycleview_empreendedor);
        ...
        adapter = new Adapter_empreendedor(this,lista_digital_influence);
        ...
        recyclerView_lista_digital.addOnItemTouchListener(new RecyclerItemClickListener(this,
            ...
            public void onItemClick(View view, int position) {
                List<Categoria_empreendedor> listCategoriaAtualizado = adapter.getcategoria();

                if (listCategoriaAtualizado.size() > 0) {
                    Categoria_empreendedor categoriaselecionada = listCategoriaAtualizado.get(position);
                    Intent it = new Intent(Lista_empreendedor.this,Detalhe_empreendedor.class);
        ...
        ChildEventListenerperfil=database_usuario.orderByChild("id").equalTo(identificadorUsuario).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                icone.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent it = new Intent(Lista_empreendedor.this, MinhaConta.class);
                        startActivity(it);

                    }
                });
                Glide.with(Lista_empreendedor.this)
                        .load(iconeurl)
                        .into(icone);
