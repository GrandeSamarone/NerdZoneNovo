package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.canal_do_youtube;
...
public class Novo_canal_youtube extends AppCompatActivity implements View.OnClickListener {
    ...
    private Categoria_youtube digital;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_novo_canal_youtube);

        toolbar = findViewById(R.id.toolbarsecundario_sem_foto);
        toolbar.setTitle("Novo Canal Youtube");
        setSupportActionBar(toolbar);

        //Configuração Basica
        campotitulo = findViewById(R.id.nome_canal_youtube);
        campodesc = findViewById(R.id.desc_canal_youtube);
        campocontato = findViewById(R.id.contato_canal_youtube);
        imagem1 = findViewById(R.id.imageLojaCadastro_canal_youtube_m1);
        imagem1.setOnClickListener(this);
        imagem2 =findViewById(R.id.imageLojaCadastro_canal_youtube_m2);
        imagem2.setOnClickListener(this);
        imagem3 = findViewById(R.id.imageLojaCadastro_canal_youtube_m3);
        imagem3.setOnClickListener(this);
        imagem4 = findViewById(R.id.imageLojaCadastro_canal_youtube_m4);
        imagem4.setOnClickListener(this);
        imagem5 = findViewById(R.id.imageLojaCadastro_canal_youtube_m5);
        imagem5.setOnClickListener(this);
        imagem6 = findViewById(R.id.imageLojaCadastro_canal_youtube_m6);
        ...
        botaosalvar = findViewById(R.id.botaosalvar_canal_youtube);
    ...
    public void  Salvar_Digital_Influence(){
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(Novo_canal_youtube.this);
                ...
                taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        if(totalfotos==listaURLFotos.size()){
                            ...
                            digital.Salvar();
                            dialog.dismiss();
                            Toast toast = Toast.makeText(Novo_canal_youtube.this, "Cadastrado com sucesso!", Toast.LENGTH_SHORT);
                            toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                            toast.show();
                            Intent it = new Intent(Novo_canal_youtube.this,Lista_canal_youtube_Activity.class);
                            startActivity(it);
                            finish();
                        }
                    }
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        dialog.dismiss();
                        Toast.makeText(Novo_canal_youtube.this, "Erro ao cadastrar", Toast.LENGTH_SHORT).show();
    ...
    private Categoria_youtube configurar_categoria_influence(){
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case  R.id.imageLojaCadastro_canal_youtube_m1:
                EscolherImagem(1);
                break;
            case  R.id.imageLojaCadastro_canal_youtube_m2:
                EscolherImagem(2);
                break;
            case  R.id.imageLojaCadastro_canal_youtube_m3:
                EscolherImagem(3);
                break;
            case  R.id.imageLojaCadastro_canal_youtube_m4:
                EscolherImagem(4);
                break;
            case  R.id.imageLojaCadastro_canal_youtube_m5:
                EscolherImagem(5);
                break;
            case  R.id.imageLojaCadastro_canal_youtube_m6:
                EscolherImagem(6);
                break;

            case R.id.botaosalvar_canal_youtube:
                validarDados();
                break;
