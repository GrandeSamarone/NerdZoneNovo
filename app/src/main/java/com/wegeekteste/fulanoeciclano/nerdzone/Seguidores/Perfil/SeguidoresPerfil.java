package com.wegeekteste.fulanoeciclano.nerdzone.Seguidores.Perfil;
...
public class SeguidoresPerfil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seguidores_perfil);

        toolbar = findViewById(R.id.toolbarsecundario_sem_foto);
        toolbar.setTitle(R.string.Seguidores);
        setSupportActionBar(toolbar);

        mDatabaseseguidores= ConfiguracaoFirebase.getDatabase().getReference().child("seguidores");
        erro = findViewById(R.id.textoerrobusca_contato_seguidor);
        lineerro = findViewById(R.id.linearinformacoeserro_contato_seguidores);
        //Configuracoes Originais
        recyclerSeguidores=findViewById(R.id.lista_seguidores_perfil);

        adapterseguidores= new ContatosAdapter(ListaSeguidores,this);

        //Adapter
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL,false);
        recyclerSeguidores.setLayoutManager(layoutManager);
...
*/
    ...
    private void PesquisarContato(String texto) {
        ...
        adapterseguidores = new ContatosAdapter(listausuarioBusca, SeguidoresPerfil.this);
        recyclerSeguidores.setAdapter(adapterseguidores);
        adapterseguidores.notifyDataSetChanged();
    }
    ...
    private void RecarregarContato() {
        ...
        adapterseguidores = new ContatosAdapter(ListaSeguidores, SeguidoresPerfil.this);
        recyclerSeguidores.setAdapter(adapterseguidores);
        adapterseguidores.notifyDataSetChanged();
    }
