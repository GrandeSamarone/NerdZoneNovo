...
public class MynotificationManager {
    ...
    public void displaynotification(String title,String mensagem){
        if(android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(ctx, com.wegeekteste.fulanoeciclano.nerdzone.Helper.notificacao.Constants.CHANNEL_ID)
