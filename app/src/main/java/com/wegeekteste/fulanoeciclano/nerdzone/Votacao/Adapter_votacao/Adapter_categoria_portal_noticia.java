...
public class Adapter_categoria_portal_noticia extends RecyclerView.Adapter<Adapter_categoria_portal_noticia.MyViewHolder> {

   private ArrayList<Categoria_portal_noticia> lista_digital;
   private Context context;

   public Adapter_categoria_portal_noticia(Context c, ArrayList<Categoria_portal_noticia> categora){
       this.context=c;
