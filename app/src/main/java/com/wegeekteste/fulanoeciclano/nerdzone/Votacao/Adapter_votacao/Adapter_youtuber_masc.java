...
public class Adapter_youtuber_masc extends RecyclerView.Adapter<Adapter_youtuber_masc.MyViewHolder> {

    private ArrayList<Categoria_youtuber_masc> lista_digital;
    private Context context;

    public Adapter_youtuber_masc(Context c, ArrayList<Categoria_youtuber_masc> categora){
        this.context=c;
