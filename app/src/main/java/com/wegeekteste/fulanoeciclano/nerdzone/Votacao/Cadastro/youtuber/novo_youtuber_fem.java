package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.youtuber;
...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.model_votacao.Categoria_youtuber_fem;
...
public class novo_youtuber_fem extends AppCompatActivity implements View.OnClickListener {
    ...
    private Categoria_youtuber_fem digital;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_novo_youtuber_fem);
        toolbar = findViewById(R.id.toolbarsecundario_sem_foto);
        toolbar.setTitle("Novo Yotuber Fem");
        setSupportActionBar(toolbar);

        //Configuração Basica
        campotitulo = findViewById(R.id.nome_youtuber_fem);
        campodesc = findViewById(R.id.desc_youtuber_fem);
        campocontato = findViewById(R.id.contato_youtuber_fem);
        imagem1 = findViewById(R.id.imageLojaCadastro_youtuber_fem_m1);
        imagem1.setOnClickListener(this);
        imagem2 =findViewById(R.id.imageLojaCadastro_youtuber_fem_m2);
        imagem2.setOnClickListener(this);
        imagem3 = findViewById(R.id.imageLojaCadastro_youtuber_fem_m3);
        imagem3.setOnClickListener(this);
        imagem4 = findViewById(R.id.imageLojaCadastro_youtuber_fem_m4);
        imagem4.setOnClickListener(this);
        imagem5 = findViewById(R.id.imageLojaCadastro_youtuber_fem_m5);
        imagem5.setOnClickListener(this);
        imagem6 = findViewById(R.id.imageLojaCadastro_youtuber_fem_m6);
        imagem6.setOnClickListener(this);

        digital = new Categoria_youtuber_fem();
        storageReference = ConfiguracaoFirebase.getFirebaseStorage();
        database = ConfiguracaoFirebase.getDatabase().getReference()
                .child("votacao").child("categorias").child("youtuber_fem");
        databaseconta = ConfiguracaoFirebase.getDatabase().getReference().child("usuarios");
        identificadorUsuario = UsuarioFirebase.getIdentificadorUsuario();
        usuarioLogado = UsuarioFirebase.getDadosUsuarioLogado();
        botaosalvar = findViewById(R.id.botaosalvar_youtuber_fem);
    ...
    public void  Salvar_Digital_Influence(){
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(novo_youtuber_fem.this);
                ...
                taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        if(totalfotos==listaURLFotos.size()){
                            ...
                            digital.Salvar();
                            dialog.dismiss();
                            Toast toast = Toast.makeText(novo_youtuber_fem.this, "Cadastrado com sucesso!", Toast.LENGTH_SHORT);
                            toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                            toast.show();
                            Intent it = new Intent(novo_youtuber_fem.this,Lista_youtuber_fem.class);
                            startActivity(it);
                            finish();
                        }
                    }
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        dialog.dismiss();
                        Toast.makeText(novo_youtuber_fem.this, "Erro ao cadastrar", Toast.LENGTH_SHORT).show();
    ...
    private Categoria_youtuber_fem configurar_categoria_influence(){
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case  R.id.imageLojaCadastro_youtuber_fem_m1:
                EscolherImagem(1);
                break;
            case  R.id.imageLojaCadastro_youtuber_fem_m2:
                EscolherImagem(2);
                break;
            case  R.id.imageLojaCadastro_youtuber_fem_m3:
                EscolherImagem(3);
                break;
            case  R.id.imageLojaCadastro_youtuber_fem_m4:
                EscolherImagem(4);
                break;
            case  R.id.imageLojaCadastro_youtuber_fem_m5:
                EscolherImagem(5);
                break;
            case  R.id.imageLojaCadastro_youtuber_fem_m6:
                EscolherImagem(6);
                break;

            case R.id.botaosalvar_youtuber_fem:
                validarDados();
                break;
