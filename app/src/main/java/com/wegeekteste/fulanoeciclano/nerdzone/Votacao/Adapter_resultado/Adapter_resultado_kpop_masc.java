...
public class Adapter_resultado_kpop_masc extends RecyclerView.Adapter<Adapter_resultado_kpop_masc.MyViewHolder> {

    private ArrayList<Categoria_kpop_masc> lista_digital;
    private Context context;

    public Adapter_resultado_kpop_masc(Context c, ArrayList<Categoria_kpop_masc> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_kpop_masc> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_kpop_masc getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_kpop_masc categoria_pessoa = lista_digital.get(position);
