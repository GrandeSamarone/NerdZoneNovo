...
public class Adapter_escritor_fem extends RecyclerView.Adapter<Adapter_escritor_fem.MyViewHolder> {

    private ArrayList<Categoria_escritor_fem> lista_digital;
    private Context context;

    public Adapter_escritor_fem(Context c, ArrayList<Categoria_escritor_fem> categora){
        this.context=c;
