...
public class Adapter_cosplay_masc extends RecyclerView.Adapter<Adapter_cosplay_masc.MyViewHolder> {

    private ArrayList<Categoria_cosplay_masc> lista_digital;
    private Context context;

    public Adapter_cosplay_masc(Context c, ArrayList<Categoria_cosplay_masc> categora){
        this.context=c;
