...
public class Adapter_empreendedor extends RecyclerView.Adapter<Adapter_empreendedor.MyViewHolder> {

    private ArrayList<Categoria_empreendedor> lista_digital;
    private Context context;

    public Adapter_empreendedor(Context c, ArrayList<Categoria_empreendedor> categora){
        this.context=c;
