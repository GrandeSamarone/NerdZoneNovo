...
public class Adapter_categoria_pessoa_masc extends RecyclerView.Adapter<Adapter_categoria_pessoa_masc.MyViewHolder> {

   private ArrayList<Categoria_Pessoa_masc> lista_digital;
   private Context context;

   public Adapter_categoria_pessoa_masc(Context c, ArrayList<Categoria_Pessoa_masc> categora){
       this.context=c;
