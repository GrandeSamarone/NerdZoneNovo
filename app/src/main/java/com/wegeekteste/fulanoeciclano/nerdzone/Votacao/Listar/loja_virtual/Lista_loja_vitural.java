package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Listar.loja_virtual;
...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Adapter_votacao.Adapter_loja_virtual;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.loja_virtual.novo_loja_virtual;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Detalhe.Detalhe_Loja_virtual;
...
public class Lista_loja_vitural extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private Adapter_loja_virtual adapter;
    ...
    private ArrayList<Categoria_loja_virtual> lista_digital_influence = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_loja_vitural);

        toolbar = findViewById(R.id.toolbarsecundario);
        toolbar.setTitle("Loja Virtual");
        setSupportActionBar(toolbar);

        //Configuracoes Originais
        linear_nada_cadastrado = findViewById(R.id.linear_nada_cadastrado_loja);
        novo_influencer = findViewById(R.id.buton_novo_loja_virtual);
        novo_influencer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent( Lista_loja_vitural.this,novo_loja_virtual.class);
                startActivity(it);
                finish();
            }
        });
        ...
        refresh = findViewById(R.id.refresh_loja_virtual);
        ...
        recyclerView_lista_digital = findViewById(R.id.recycleview_loja_virtual);
        ...
        adapter = new Adapter_loja_virtual(this,lista_digital_influence);
        ...
        recyclerView_lista_digital.addOnItemTouchListener(new RecyclerItemClickListener(this,
            ...
            public void onItemClick(View view, int position) {
                List<Categoria_loja_virtual> listCategoriaAtualizado = adapter.getcategoria();

                if (listCategoriaAtualizado.size() > 0) {
                    Categoria_loja_virtual categoriaselecionada = listCategoriaAtualizado.get(position);
                    Intent it = new Intent(Lista_loja_vitural.this,Detalhe_Loja_virtual.class);
    ...
    private void RecuperarLista_digital_fem(){
        ...
        valuedigitalListener = mDatabase_digital.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                Categoria_loja_virtual cat = dataSnapshot.getValue(Categoria_loja_virtual.class);
        ...
        ChildEventListenerperfil=database_usuario.orderByChild("id").equalTo(identificadorUsuario).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                icone.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent it = new Intent(Lista_loja_vitural.this, MinhaConta.class);
                        startActivity(it);

                    }
                });
                Glide.with(Lista_loja_vitural.this)
                        .load(iconeurl)
                        .into(icone);
