package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Listar.espaco_geek;
...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Adapter_votacao.Adapter_espaco_geek;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.espaco_geek.novo_espaco_geek;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Detalhe.Detalhe_espaco_geek;
...
public class Lista_espaco_geek extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private Adapter_espaco_geek adapter;
    ...
    private ArrayList<Categoria_espaco_geek> lista_digital_influence = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        novo_influencer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent( Lista_espaco_geek.this,novo_espaco_geek.class);
                startActivity(it);
                finish();
            }
        });
        ...
        refresh = findViewById(R.id.refresh_espaco_geek);
        ...
        recyclerView_lista_digital = findViewById(R.id.recycleview_espaco_geek);
        ...
        adapter = new Adapter_espaco_geek(this,lista_digital_influence);
        ...
        recyclerView_lista_digital.addOnItemTouchListener(new RecyclerItemClickListener(this,
            ...
            public void onItemClick(View view, int position) {
                List<Categoria_espaco_geek> listCategoriaAtualizado = adapter.getcategoria();

                if (listCategoriaAtualizado.size() > 0) {
                    Categoria_espaco_geek categoriaselecionada = listCategoriaAtualizado.get(position);
                    Intent it = new Intent(Lista_espaco_geek.this,Detalhe_espaco_geek.class);
        ...
        ChildEventListenerperfil=database_usuario.orderByChild("id").equalTo(identificadorUsuario).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                icone.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent it = new Intent(Lista_espaco_geek.this, MinhaConta.class);
                        startActivity(it);

                    }
                });
                Glide.with(Lista_espaco_geek.this)
                        .load(iconeurl)
                        .into(icone);
