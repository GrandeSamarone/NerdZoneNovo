...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Resultados.Resultado_empreendedor;
...
public class Detalhe_empreendedor extends AppCompatActivity {
    ...
    private Categoria_empreendedor categoriaselecionado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalhe_empreendedor);

        toolbar = findViewById(R.id.toolbar_detalhe_empreendedor_masc  );
        ...
        fotos = findViewById(R.id.carousel_foto_selecionada_empreendedor_masc);
        perfil = findViewById(R.id.icone_author_selecionado_empreendedor_masc);
        titulo = findViewById(R.id.detalhe_selecionado_empreendedor_masc_titulo);
        toolbar_texto = findViewById(R.id.texto_Toolbar_empreendedor_masc);
        criador = findViewById(R.id.detalhe_selecionado_empreendedor_masc_criador);
        descricao = findViewById(R.id.detalhe_selecionad_empreendedor_masc_descricao);
        click = findViewById(R.id.click_layout);

        categoriaselecionado = (Categoria_empreendedor) getIntent().getSerializableExtra("categoria_selecionada");

        if(categoriaselecionado!=null){
            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(this);
            builder.setCancelable(false);
            LayoutInflater layoutInflater = LayoutInflater.from(Detalhe_empreendedor.this);
            ...
            fotos.setImageClickListener(new ImageClickListener() {
                ...
                public void onClick(int position) {
                    ...
                    */
                    ...
                    Intent it = new Intent(Detalhe_empreendedor.this, AbrirImagemComercio.class);
        ...
        ChildEventListeneruser = database_usuario.orderByChild("id")
                .equalTo(idusuario).addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        ...
                        Glide.with(Detalhe_empreendedor.this)
                                .load(foto)
                                .into(perfil);
                        ...
                        if (!identificadorUsuario.equals(user.getId())) {
                            click.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent it = new Intent(Detalhe_empreendedor.this, Perfil.class);
                            ...
                            click.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    Intent it = new Intent(Detalhe_empreendedor.this, MinhaConta.class);
                                    it.putExtra("id", user.getId());
                                    startActivity(it);
                                }
                            });
    ...
    private void ValidarVoto() {
        ...
        mDatabasecategoria.child(categoriaselecionado.getId()).updateChildren(dados).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                dialog.dismiss();
                Toast toast = Toast.makeText(Detalhe_empreendedor.this, "Voto confirmado com sucesso!",Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                toast.show();
                Intent it = new Intent(Detalhe_empreendedor.this, Resultado_empreendedor.class);
                startActivity(it);
                finish();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                dialog.dismiss();
                Toast toast = Toast.makeText(Detalhe_empreendedor.this, "Ocorreu um erro, tente novamente ou verifique sua conexão"
                        ,Toast.LENGTH_LONG);
                toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                toast.show();
            }
