package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Listar.portal_noticia;
...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Adapter_votacao.Adapter_categoria_portal_noticia;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.portal_de_noticia.novo_portal_de_noticia;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Detalhe.Detalhe_portal_noticia;
...
public class Lista_portal_noticia extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private Adapter_categoria_portal_noticia adapter;
    ...
    private ArrayList<Categoria_portal_noticia> lista_digital_influence = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        novo_influencer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(Lista_portal_noticia.this, novo_portal_de_noticia.class);
                startActivity(it);
                finish();
            }
        });
        ...
        refresh = findViewById(R.id.refresh_portal_noticia);
        ...
        recyclerView_lista_digital = findViewById(R.id.recycleview_portal_noticia);
        ...
        adapter = new Adapter_categoria_portal_noticia(this, lista_digital_influence);
        ...
        recyclerView_lista_digital.addOnItemTouchListener(new RecyclerItemClickListener(this,
            ...
            public void onItemClick(View view, int position) {
                List<Categoria_portal_noticia> listCategoriaAtualizado = adapter.getcategoria();

                if (listCategoriaAtualizado.size() > 0) {
                    Categoria_portal_noticia categoriaselecionada = listCategoriaAtualizado.get(position);
                    Intent it = new Intent(Lista_portal_noticia.this, Detalhe_portal_noticia.class);
        ...
        ChildEventListenerperfil=database_usuario.orderByChild("id").equalTo(identificadorUsuario).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                icone.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent it = new Intent(Lista_portal_noticia.this, MinhaConta.class);
                        startActivity(it);

                    }
                });
                Glide.with(Lista_portal_noticia.this)
                        .load(iconeurl)
                        .into(icone);
