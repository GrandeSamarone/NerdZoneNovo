...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Adapter_votacao.Adapter_cosplay_fem;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.cosplay.novo_cosplay_fem;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Detalhe.Detalhe_cosplay_fem;
...
public class Lista_cosplay_Femi extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private Adapter_cosplay_fem adapter;
    ...
    private ArrayList<Categoria_cosplay_fem> lista_digital_influence = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_cosplay__femi);

        toolbar = findViewById(R.id.toolbarsecundario);
        toolbar.setTitle("Cosplay Feminino");
        ...
        novo_influencer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(Lista_cosplay_Femi.this, novo_cosplay_fem.class);
                startActivity(it);
                finish();
            }
        });
        ...
        refresh = findViewById(R.id.refresh_cosplay_fem);
        ...
        recyclerView_lista_digital = findViewById(R.id.recycleview_cosplay_fem);
        ...
        adapter = new Adapter_cosplay_fem(this, lista_digital_influence);
        ...
        recyclerView_lista_digital.addOnItemTouchListener(new RecyclerItemClickListener(this,
            ...
            public void onItemClick(View view, int position) {
                List<Categoria_cosplay_fem> listCategoriaAtualizado = adapter.getcategoria();

                if (listCategoriaAtualizado.size() > 0) {
                    Categoria_cosplay_fem categoriaselecionada = listCategoriaAtualizado.get(position);
                    Intent it = new Intent(Lista_cosplay_Femi.this, Detalhe_cosplay_fem.class);
        ...
        ChildEventListenerperfil=database_usuario.orderByChild("id").equalTo(identificadorUsuario).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                icone.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent it = new Intent(Lista_cosplay_Femi.this, MinhaConta.class);
                        startActivity(it);

                    }
                });
                Glide.with(Lista_cosplay_Femi.this)
                        .load(iconeurl)
                        .into(icone);
