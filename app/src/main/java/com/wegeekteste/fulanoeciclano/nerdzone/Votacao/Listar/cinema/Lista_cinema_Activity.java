package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Listar.cinema;
...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Adapter_votacao.Adapter_cinema;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.cinema.novo_cinema;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Detalhe.Detalhe_cinema;
...
public class Lista_cinema_Activity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private Adapter_cinema adapter;
    ...
    private ArrayList<Categoria_cinema> lista_digital_influence = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_cinema_);
        ...
        novo_influencer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent( Lista_cinema_Activity.this,novo_cinema.class);
                startActivity(it);
                finish();
            }
        });
        ...
        refresh = findViewById(R.id.refresh_cinema);
        ...
        recyclerView_lista_digital = findViewById(R.id.recycleview_cinema);
        ...
        adapter = new Adapter_cinema(this,lista_digital_influence);
        ...
        recyclerView_lista_digital.addOnItemTouchListener(new RecyclerItemClickListener(this,
            ...
            public void onItemClick(View view, int position) {
                List<Categoria_cinema> listCategoriaAtualizado = adapter.getcategoria();

                if (listCategoriaAtualizado.size() > 0) {
                    Categoria_cinema categoriaselecionada = listCategoriaAtualizado.get(position);
                    Intent it = new Intent(Lista_cinema_Activity.this,Detalhe_cinema.class);
        ...
        ChildEventListenerperfil=database_usuario.orderByChild("id").equalTo(identificadorUsuario).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                icone.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent it = new Intent(Lista_cinema_Activity.this, MinhaConta.class);
                        startActivity(it);

                    }
                });
                Glide.with(Lista_cinema_Activity.this)
                        .load(iconeurl)
                        .into(icone);
