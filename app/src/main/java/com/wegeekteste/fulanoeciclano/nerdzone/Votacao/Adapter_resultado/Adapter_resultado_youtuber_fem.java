...
public class Adapter_resultado_youtuber_fem extends RecyclerView.Adapter<Adapter_resultado_youtuber_fem.MyViewHolder> {

    private ArrayList<Categoria_youtuber_fem> lista_digital;
    private Context context;

    public Adapter_resultado_youtuber_fem(Context c, ArrayList<Categoria_youtuber_fem> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_youtuber_fem> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_youtuber_fem getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_youtuber_fem categoria_pessoa = lista_digital.get(position);
