...
public class Adapter_resultado_empreendedor_masc extends RecyclerView.Adapter<Adapter_resultado_empreendedor_masc.MyViewHolder> {

    private ArrayList<Categoria_empreendedor> lista_digital;
    private Context context;

    public Adapter_resultado_empreendedor_masc(Context c, ArrayList<Categoria_empreendedor> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_empreendedor> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_empreendedor getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_empreendedor categoria_pessoa = lista_digital.get(position);
