package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Listar.cosplay;
...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Adapter_votacao.Adapter_cosplay_masc;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.cosplay.novo_cosplay_masc;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Detalhe.Detalhe_cosplay_masc;
...
public class Lista_cosplay_masc extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private Adapter_cosplay_masc adapter;
    ...
    private ArrayList<Categoria_cosplay_masc> lista_digital_influence = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_cosplay_masc);

        toolbar = findViewById(R.id.toolbarsecundario);
        toolbar.setTitle("Cosplay Masculino");
        setSupportActionBar(toolbar);

        //Configuracoes Originais
        linear_nada_cadastrado = findViewById(R.id.linear_nada_cadastrado_cosplay_masc);
        novo_influencer = findViewById(R.id.buton_novo_cosplay_masc);
        novo_influencer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent( Lista_cosplay_masc.this,novo_cosplay_masc.class);
                startActivity(it);
                finish();
            }
        });
        ...
        refresh = findViewById(R.id.refresh_cosplay_masc);
        ...
        recyclerView_lista_digital = findViewById(R.id.recycleview_cosplay_masc);
        ...
        adapter = new Adapter_cosplay_masc(this,lista_digital_influence);
        ...
        recyclerView_lista_digital.addOnItemTouchListener(new RecyclerItemClickListener(this,
            ...
            public void onItemClick(View view, int position) {
                List<Categoria_cosplay_masc> listCategoriaAtualizado = adapter.getcategoria();
      ...
      linear_nada_cadastrado.setVisibility(View.VISIBLE);
        ...
        valuedigitalListener = mDatabase_digital.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                Categoria_cosplay_masc cat = dataSnapshot.getValue(Categoria_cosplay_masc.class);
        ...
        ChildEventListenerperfil=database_usuario.orderByChild("id").equalTo(identificadorUsuario).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                icone.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent it = new Intent(Lista_cosplay_masc.this, MinhaConta.class);
                        startActivity(it);

                    }
                });
                Glide.with(Lista_cosplay_masc.this)
                        .load(iconeurl)
                        .into(icone);
