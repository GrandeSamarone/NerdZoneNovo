...
public class Adapter_resultado_digital_fem extends RecyclerView.Adapter<Adapter_resultado_digital_fem.MyViewHolder> {

    private ArrayList<Categoria_pessoa_fem> lista_digital;
    private Context context;

    public Adapter_resultado_digital_fem(Context c, ArrayList<Categoria_pessoa_fem> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_pessoa_fem> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_pessoa_fem getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_pessoa_fem categoria_pessoa = lista_digital.get(position);
