...
public class Adapter_cinema extends RecyclerView.Adapter<Adapter_cinema.MyViewHolder> {

    private ArrayList<Categoria_cinema> lista_digital;
    private Context context;

    public Adapter_cinema(Context c, ArrayList<Categoria_cinema> categora){
        this.context=c;
