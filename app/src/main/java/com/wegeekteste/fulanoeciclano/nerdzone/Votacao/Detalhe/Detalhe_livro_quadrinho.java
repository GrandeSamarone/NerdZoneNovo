...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Resultados.Resultado_livro_quadrinho;
...
public class Detalhe_livro_quadrinho extends AppCompatActivity {
    ...
    private Categoria_livro_quadrinho categoriaselecionado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.toolbar_detalhe_detalhe_livro_quad);
        ...
        fotos = findViewById(R.id.carousel_foto_selecionada_livro_quad);
        perfil = findViewById(R.id.icone_author_livro_quad);
        titulo = findViewById(R.id.detalhe_selecionado_livro_quad_titulo);
        toolbar_texto = findViewById(R.id.texto_Toolbar_detalhe_noticia);
        criador = findViewById(R.id.detalhe_selecionado_nome_livro_quad);
        descricao = findViewById(R.id.detalhe_descricao_livro_quad);
        click = findViewById(R.id.click_layout);

        categoriaselecionado = (Categoria_livro_quadrinho) getIntent().getSerializableExtra("categoria_selecionada");

        if(categoriaselecionado!=null){
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setCancelable(false);
            LayoutInflater layoutInflater = LayoutInflater.from(Detalhe_livro_quadrinho.this);
            ...
            fotos.setImageClickListener(new ImageClickListener() {
                ...
                public void onClick(int position) {
                    ...
                    */
                    ...
                    Intent it = new Intent(Detalhe_livro_quadrinho.this, AbrirImagemComercio.class);
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        ...
                        if (!identificadorUsuario.equals(user.getId())) {
                            ...
                            click.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    Intent it = new Intent(Detalhe_livro_quadrinho.this, MinhaConta.class);
                                    it.putExtra("id", user.getId());
                                    startActivity(it);
                                }
                            });
    ...
    private void ValidarVoto() {
        ...
        mDatabasecategoria.child(categoriaselecionado.getId()).updateChildren(dados).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                dialog.dismiss();
                Toast toast = Toast.makeText(Detalhe_livro_quadrinho.this, "Voto confirmado com sucesso!",Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                toast.show();
                Intent it = new Intent(Detalhe_livro_quadrinho.this, Resultado_livro_quadrinho.class);
                startActivity(it);
                finish();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                dialog.dismiss();
                Toast toast = Toast.makeText(Detalhe_livro_quadrinho.this, "Ocorreu um erro, tente novamente ou verifique sua conexão"
                        ,Toast.LENGTH_LONG);
                toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                toast.show();
            }
