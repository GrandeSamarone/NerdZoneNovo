...
public class Adapter_kpop_masc extends RecyclerView.Adapter<Adapter_kpop_masc.MyViewHolder> {

    private ArrayList<Categoria_kpop_masc> lista_digital;
    private Context context;

    public Adapter_kpop_masc(Context c, ArrayList<Categoria_kpop_masc> categora){
        this.context=c;
