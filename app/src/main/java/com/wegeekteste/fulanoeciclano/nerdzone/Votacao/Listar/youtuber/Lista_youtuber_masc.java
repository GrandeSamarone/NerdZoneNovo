...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Adapter_votacao.Adapter_youtuber_masc;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.youtuber.novo_youtuber_masc;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Detalhe.Detalhe_youtuber_masc;
...
public class Lista_youtuber_masc extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private Adapter_youtuber_masc adapter;
    ...
    private ArrayList<Categoria_youtuber_masc> lista_digital_influence = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_youtuber_masc);

        toolbar = findViewById(R.id.toolbarsecundario);
        toolbar.setTitle("Youtuber Masculino");
        setSupportActionBar(toolbar);

        //Configuracoes Originais
        linear_nada_cadastrado = findViewById(R.id.linear_nada_cadastrado_youtube_masc);
        novo_influencer = findViewById(R.id.buton_novo_youtuber_masc);
        novo_influencer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent( Lista_youtuber_masc.this,novo_youtuber_masc.class);
                startActivity(it);
                finish();
            }
        });
        ...
        refresh = findViewById(R.id.refresh_youtube_masc);
        ...
        recyclerView_lista_digital = findViewById(R.id.recycleview_yotuber_masc);
        ...
        adapter = new Adapter_youtuber_masc(this,lista_digital_influence);
        ...
        recyclerView_lista_digital.addOnItemTouchListener(new RecyclerItemClickListener(this,
            ...
            public void onItemClick(View view, int position) {
                List<Categoria_youtuber_masc> listCategoriaAtualizado = adapter.getcategoria();

                if (listCategoriaAtualizado.size() > 0) {
                    Categoria_youtuber_masc categoriaselecionada = listCategoriaAtualizado.get(position);
                    Intent it = new Intent(Lista_youtuber_masc.this,Detalhe_youtuber_masc.class);
    ...
    private void RecuperarLista_digital_masc(){
        ...
        valuedigitalListener = mDatabase_digital.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                Categoria_youtuber_masc cat = dataSnapshot.getValue(Categoria_youtuber_masc.class);
        ...
        ChildEventListenerperfil=database_usuario.orderByChild("id").equalTo(identificadorUsuario).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                icone.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent it = new Intent(Lista_youtuber_masc.this, MinhaConta.class);
                        startActivity(it);

                    }
                });
                Glide.with(Lista_youtuber_masc.this)
                        .load(iconeurl)
                        .into(icone);
