...
public class novo_digital_fem extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_novo_digital_fem);


        toolbar = findViewById(R.id.toolbarsecundario_sem_foto);
        toolbar.setTitle("Novo feminino");
        setSupportActionBar(toolbar);

        //Configuração Basica
        campotitulo = findViewById(R.id.nome_digital_fem);
        campodesc = findViewById(R.id.desc_digital_fem);
        campocontato = findViewById(R.id.desc_contato_digital_fem);
        imagem1 = findViewById(R.id.imageLojaCadastro_digital_f1);
        imagem1.setOnClickListener(this);
        imagem2 =findViewById(R.id.imageLojaCadastro_digital_f2);
        imagem2.setOnClickListener(this);
        imagem3 = findViewById(R.id.imageLojaCadastro_digital_f3);
        imagem3.setOnClickListener(this);
        imagem4 = findViewById(R.id.imageLojaCadastro_digital_f4);
        imagem4.setOnClickListener(this);
        imagem5 = findViewById(R.id.imageLojaCadastro_digital_f5);
        imagem5.setOnClickListener(this);
        imagem6 = findViewById(R.id.imageLojaCadastro_digital_f6);
        ...
        botaosalvar = findViewById(R.id.botaosalvar_digital_influence_fem);
    ...
    public void  Salvar_Digital_Influence(){
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(novo_digital_fem.this);
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Intent it = new Intent(novo_digital_fem.this,Lista_digital_fem.class);
                        startActivity(it);
                        finish();
                    }
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        dialog.dismiss();
                        Toast.makeText(novo_digital_fem.this, "Erro ao cadastrar", Toast.LENGTH_SHORT).show();
    ...
    private Categoria_pessoa_fem configurar_categoria_influence(){
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case  R.id.imageLojaCadastro_digital_f1:
                EscolherImagem(1);
                break;
            case  R.id.imageLojaCadastro_digital_f2:
                EscolherImagem(2);
                break;
            case  R.id.imageLojaCadastro_digital_f3:
                EscolherImagem(3);
                break;
            case  R.id.imageLojaCadastro_digital_f4:
                EscolherImagem(4);
                break;
            case  R.id.imageLojaCadastro_digital_f5:
                EscolherImagem(5);
                break;
            case  R.id.imageLojaCadastro_digital_f6:
                EscolherImagem(6);
                break;

            case R.id.botaosalvar_digital_influence_fem:
                validarDados();
                break;
