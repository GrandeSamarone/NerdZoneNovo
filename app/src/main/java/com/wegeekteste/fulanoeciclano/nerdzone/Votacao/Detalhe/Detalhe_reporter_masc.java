...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Resultados.Resultado_reporter_masc;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.model_votacao.Categoria_reporter_masc;
...
public class Detalhe_reporter_masc extends AppCompatActivity {
    ...
    private Categoria_reporter_masc categoriaselecionado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalhe_reporter_masc);

        toolbar = findViewById(R.id.toolbar_detalhe_reporter_masc  );
        ...
        fotos = findViewById(R.id.carousel_foto_selecionada_reporter_masc);
        perfil = findViewById(R.id.icone_author_selecionado_reporter_masc);
        titulo = findViewById(R.id.detalhe_selecionado_reporter_masc_titulo);
        toolbar_texto = findViewById(R.id.texto_Toolbar_reporter_masc);
        criador = findViewById(R.id.detalhe_selecionado_reporter_masc_criador);
        descricao = findViewById(R.id.detalhe_selecionad_reporter_masc_descricao);
        click = findViewById(R.id.click_layout);

        categoriaselecionado = (Categoria_reporter_masc) getIntent().getSerializableExtra("categoria_selecionada");

        if(categoriaselecionado!=null){
            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(this);
            builder.setCancelable(false);
            LayoutInflater layoutInflater = LayoutInflater.from(Detalhe_reporter_masc.this);
            ...
            fotos.setImageClickListener(new ImageClickListener() {
                ...
                public void onClick(int position) {
                    ...
                    */
                    ...
                    Intent it = new Intent(Detalhe_reporter_masc.this, AbrirImagemComercio.class);
                        ...
                        if (!identificadorUsuario.equals(user.getId())) {
                            click.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent it = new Intent(Detalhe_reporter_masc.this, Perfil.class);
                            ...
                            click.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    Intent it = new Intent(Detalhe_reporter_masc.this, MinhaConta.class);
                                    it.putExtra("id", user.getId());
                                    startActivity(it);
                                }
                            });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        private void ValidarVoto() {
            ...
            dialog = builder.create();
            dialog.show();
            mDatabasecategoria.orderByChild("id").equalTo(categoriaselecionado.getId()).addChildEventListener(new ChildEventListener() {
                @Override
                public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    Categoria_reporter_masc categoria = dataSnapshot.getValue(Categoria_reporter_masc.class);
                    Log.i("asdsds", String.valueOf(categoria.getVotos()));
                    VotosAtualizado=categoria.getVotos();
                    int qtdVotos=VotosAtualizado+1;
                    ...
                    mDatabasecategoria.child(categoriaselecionado.getId()).updateChildren(dados).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            dialog.dismiss();
                            Toast toast = Toast.makeText(Detalhe_reporter_masc.this, "Voto confirmado com sucesso!",Toast.LENGTH_SHORT);
                            toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                            toast.show();
                            Intent it = new Intent(Detalhe_reporter_masc.this, Resultado_reporter_masc.class);
                            startActivity(it);
                            finish();
                        }
                        ...
                        public void onFailure(@NonNull Exception e) {
                            dialog.dismiss();
                            Toast toast = Toast.makeText(Detalhe_reporter_masc.this, "Ocorreu um erro, tente novamente ou verifique sua conexão"
                                    ,Toast.LENGTH_LONG);
                            toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                            toast.show();
                        }
