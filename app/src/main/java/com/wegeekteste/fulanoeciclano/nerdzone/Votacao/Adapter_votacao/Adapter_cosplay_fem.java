...
public class Adapter_cosplay_fem extends RecyclerView.Adapter<Adapter_cosplay_fem.MyViewHolder> {

    private ArrayList<Categoria_cosplay_fem> lista_digital;
    private Context context;

    public Adapter_cosplay_fem(Context c, ArrayList<Categoria_cosplay_fem> categora){
        this.context=c;
