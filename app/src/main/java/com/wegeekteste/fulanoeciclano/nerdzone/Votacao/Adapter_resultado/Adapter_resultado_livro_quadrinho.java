...
public class Adapter_resultado_livro_quadrinho extends RecyclerView.Adapter<Adapter_resultado_livro_quadrinho.MyViewHolder> {

    private ArrayList<Categoria_livro_quadrinho> lista_digital;
    private Context context;

    public Adapter_resultado_livro_quadrinho(Context c, ArrayList<Categoria_livro_quadrinho> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_livro_quadrinho> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_livro_quadrinho getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_livro_quadrinho categoria_pessoa = lista_digital.get(position);
