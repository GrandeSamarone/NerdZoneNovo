...
public class Adapter_resultado_reporter_masc extends RecyclerView.Adapter<Adapter_resultado_reporter_masc.MyViewHolder> {

    private ArrayList<Categoria_reporter_masc> lista_digital;
    private Context context;

    public Adapter_resultado_reporter_masc(Context c, ArrayList<Categoria_reporter_masc> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_reporter_masc> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_reporter_masc getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_reporter_masc categoria_pessoa = lista_digital.get(position);
