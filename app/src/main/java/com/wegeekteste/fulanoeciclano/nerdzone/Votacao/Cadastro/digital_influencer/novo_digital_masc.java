package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.digital_influencer;
...
public class novo_digital_masc extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Configuração Basica
        campotitulo = findViewById(R.id.nome_digital_masc);
        campodesc = findViewById(R.id.desc_digital_masc);
        campocontato = findViewById(R.id.desc_contato_digital);
        imagem1 = findViewById(R.id.imageLojaCadastro_digital_m1);
        imagem1.setOnClickListener(this);
        imagem2 =findViewById(R.id.imageLojaCadastro_digital_m2);
        imagem2.setOnClickListener(this);
        imagem3 = findViewById(R.id.imageLojaCadastro_digital_m3);
        imagem3.setOnClickListener(this);
        imagem4 = findViewById(R.id.imageLojaCadastro_digital_m4);
        imagem4.setOnClickListener(this);
        imagem5 = findViewById(R.id.imageLojaCadastro_digital_m5);
        imagem5.setOnClickListener(this);
        imagem6 = findViewById(R.id.imageLojaCadastro_digital_m6);
        imagem6.setOnClickListener(this);

        digital = new Categoria_Pessoa_masc();
        storageReference = ConfiguracaoFirebase.getFirebaseStorage();
        database = ConfiguracaoFirebase.getDatabase().getReference().child("votacao").child("categorias").child("digital_influence_masc");
        databaseconta = ConfiguracaoFirebase.getDatabase().getReference().child("usuarios");
        identificadorUsuario = UsuarioFirebase.getIdentificadorUsuario();
        usuarioLogado = UsuarioFirebase.getDadosUsuarioLogado();
        botaosalvar = findViewById(R.id.botaosalvar_digital_influence);
    ...
    public void  Salvar_Digital_Influence(){
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(novo_digital_masc.this);
                ...
                taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        if(totalfotos==listaURLFotos.size()){
                            ...
                            digital.Salvar();
                            dialog.dismiss();
                           Intent it = new Intent(novo_digital_masc.this,Lista_digital_masc.class);
                           startActivity(it);
                           finish();
                        }
                    }
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        dialog.dismiss();
                        Toast.makeText(novo_digital_masc.this, "Erro ao cadastrar", Toast.LENGTH_SHORT).show();
    ...
    private Categoria_Pessoa_masc configurar_categoria_influence(){
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case  R.id.imageLojaCadastro_digital_m1:
                EscolherImagem(1);
                break;
            case  R.id.imageLojaCadastro_digital_m2:
                EscolherImagem(2);
                break;
            case  R.id.imageLojaCadastro_digital_m3:
                EscolherImagem(3);
                break;
            case  R.id.imageLojaCadastro_digital_m4:
                EscolherImagem(4);
                break;
            case  R.id.imageLojaCadastro_digital_m5:
                EscolherImagem(5);
                break;
            case  R.id.imageLojaCadastro_digital_m6:
                EscolherImagem(6);
                break;

            case R.id.botaosalvar_digital_influence:
                    validarDados();
                    break;
