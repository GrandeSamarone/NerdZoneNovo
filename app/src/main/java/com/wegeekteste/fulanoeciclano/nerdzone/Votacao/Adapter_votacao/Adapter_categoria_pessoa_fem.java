...
public class Adapter_categoria_pessoa_fem extends RecyclerView.Adapter<Adapter_categoria_pessoa_fem.MyViewHolder> {

   private ArrayList<Categoria_pessoa_fem> lista_digital;
   private Context context;

   public Adapter_categoria_pessoa_fem(Context c, ArrayList<Categoria_pessoa_fem> categora){
       this.context=c;
