...
public class Adapter_youtuber_fem extends RecyclerView.Adapter<Adapter_youtuber_fem.MyViewHolder> {

    private ArrayList<Categoria_youtuber_fem> lista_digital;
    private Context context;

    public Adapter_youtuber_fem(Context c, ArrayList<Categoria_youtuber_fem> categora){
        this.context=c;
