...
public class Adapter_livro_quadrinho extends RecyclerView.Adapter<Adapter_livro_quadrinho.MyViewHolder> {

    private ArrayList<Categoria_livro_quadrinho> lista_digital;
    private Context context;

    public Adapter_livro_quadrinho(Context c, ArrayList<Categoria_livro_quadrinho> categora){
        this.context=c;
