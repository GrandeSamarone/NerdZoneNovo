...
public class Adapter_resultado_kpop_fem extends RecyclerView.Adapter<Adapter_resultado_kpop_fem.MyViewHolder> {

    private ArrayList<Categoria_kpop_fem> lista_digital;
    private Context context;

    public Adapter_resultado_kpop_fem(Context c, ArrayList<Categoria_kpop_fem> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_kpop_fem> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_kpop_fem getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_kpop_fem categoria_pessoa = lista_digital.get(position);
