...
public class Adapter_espaco_geek extends RecyclerView.Adapter<Adapter_espaco_geek.MyViewHolder> {

    private ArrayList<Categoria_espaco_geek> lista_digital;
    private Context context;

    public Adapter_espaco_geek(Context c, ArrayList<Categoria_espaco_geek> categora){
        this.context=c;
