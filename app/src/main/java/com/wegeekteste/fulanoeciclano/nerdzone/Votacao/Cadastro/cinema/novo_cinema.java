package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.cinema;
...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.model_votacao.Categoria_cinema;
...
public class novo_cinema extends AppCompatActivity implements View.OnClickListener {
    ...
    private Categoria_cinema digital;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_novo_cinema);

        toolbar = findViewById(R.id.toolbarsecundario_sem_foto);
        toolbar.setTitle("Novo Cinema");
        setSupportActionBar(toolbar);

        //Configuração Basica
        campotitulo = findViewById(R.id.nome_cinema);
        campodesc = findViewById(R.id.desc_cinema);
        campocontato = findViewById(R.id.contato_cinema);
        imagem1 = findViewById(R.id.imageLojaCadastro_reporter_cinema_m1);
        imagem1.setOnClickListener(this);
        imagem2 =findViewById(R.id.imageLojaCadastro_reporter_cinema_m2);
        imagem2.setOnClickListener(this);
        imagem3 = findViewById(R.id.imageLojaCadastro_reporter_cinema_m3);
        imagem3.setOnClickListener(this);
        imagem4 = findViewById(R.id.imageLojaCadastro_reporter_cinema_m4);
        imagem4.setOnClickListener(this);
        imagem5 = findViewById(R.id.imageLojaCadastro_reporter_cinema_m5);
        imagem5.setOnClickListener(this);
        imagem6 = findViewById(R.id.imageLojaCadastro_reporter_cinema_m6);
    ...
    public void  Salvar_Digital_Influence(){
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(novo_cinema.this);
                ...
                taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        if(totalfotos==listaURLFotos.size()){
                            ...
                            digital.Salvar();
                            dialog.dismiss();
                            Toast toast = Toast.makeText(novo_cinema.this, "Cadastrado com sucesso!", Toast.LENGTH_SHORT);
                            toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                            toast.show();
                            Intent it = new Intent(novo_cinema.this,Lista_cinema_Activity.class);
                            startActivity(it);
                            finish();
                        }
                    }
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        dialog.dismiss();
                        Toast.makeText(novo_cinema.this, "Erro ao cadastrar", Toast.LENGTH_SHORT).show();
    ...
    private Categoria_cinema configurar_categoria_influence(){
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case  R.id.imageLojaCadastro_reporter_cinema_m1:
                EscolherImagem(1);
                break;
            case  R.id.imageLojaCadastro_reporter_cinema_m2:
                EscolherImagem(2);
                break;
            case  R.id.imageLojaCadastro_reporter_cinema_m3:
                EscolherImagem(3);
                break;
            case  R.id.imageLojaCadastro_reporter_cinema_m4:
                EscolherImagem(4);
                break;
            case  R.id.imageLojaCadastro_reporter_cinema_m5:
                EscolherImagem(5);
                break;
            case  R.id.imageLojaCadastro_reporter_cinema_m6:
                EscolherImagem(6);
                break;

            case R.id.botaosalvar_cinema:
                validarDados();
                break;
