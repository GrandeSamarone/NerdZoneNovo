...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Resultados.Resultado_portal_noticia;
...
public class Detalhe_portal_noticia extends AppCompatActivity {
    ...
    private Categoria_portal_noticia categoriaselecionado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalhe_portal_noticia);

        toolbar = findViewById(R.id.toolbar_detalhe_portal_noticia  );
        ...
        fotos = findViewById(R.id.carousel_foto_selecionada_portal_noticia);
        perfil = findViewById(R.id.icone_author_portal_noticia);
        titulo = findViewById(R.id.detalhe_titulo_portal_noticia);
        toolbar_texto = findViewById(R.id.texto_Toolbar_portal_noticia);
        criador = findViewById(R.id.detalhe_selecionado_criador_portal_noticia);
        descricao = findViewById(R.id.detalhe__portal_noticia);
        click = findViewById(R.id.click_layout);

        categoriaselecionado = (Categoria_portal_noticia) getIntent().getSerializableExtra("categoria_selecionada");

        if(categoriaselecionado!=null){
            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(this);
            builder.setCancelable(false);
            LayoutInflater layoutInflater = LayoutInflater.from(Detalhe_portal_noticia.this);
            ...
            fotos.setImageClickListener(new ImageClickListener() {
                ...
                public void onClick(int position) {
                    ...
                    */
                    ...
                    Intent it = new Intent(Detalhe_portal_noticia.this, AbrirImagemComercio.class);
        ...
        ChildEventListeneruser = database_usuario.orderByChild("id")
                .equalTo(idusuario).addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        ...
                        Glide.with(Detalhe_portal_noticia.this)
                                .load(foto)
                                .into(perfil);
                        ...
                        if (!identificadorUsuario.equals(user.getId())) {
                            click.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent it = new Intent(Detalhe_portal_noticia.this, Perfil.class);
                            ...
                            click.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    Intent it = new Intent(Detalhe_portal_noticia.this, MinhaConta.class);
                                    it.putExtra("id", user.getId());
                                    startActivity(it);
                                }
                            });
    ...
    private void ValidarVoto() {
        ...
        mDatabasecategoria.child(categoriaselecionado.getId()).updateChildren(dados).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                dialog.dismiss();
                Toast toast = Toast.makeText(Detalhe_portal_noticia.this, "Voto confirmado com sucesso!",Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                toast.show();
                Intent it = new Intent(Detalhe_portal_noticia.this, Resultado_portal_noticia.class);
                startActivity(it);
                finish();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                dialog.dismiss();
                Toast toast = Toast.makeText(Detalhe_portal_noticia.this, "Ocorreu um erro, tente novamente ou verifique sua conexão"
                        ,Toast.LENGTH_LONG);
                toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                toast.show();
            }
