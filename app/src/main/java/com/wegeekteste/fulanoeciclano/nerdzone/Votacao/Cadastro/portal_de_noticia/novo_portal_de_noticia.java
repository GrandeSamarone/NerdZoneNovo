package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.portal_de_noticia;
...
public class novo_portal_de_noticia extends AppCompatActivity implements View.OnClickListener {
    ...
    private Categoria_portal_noticia digital;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_novo_portal_de_noticia);

        toolbar = findViewById(R.id.toolbarsecundario_sem_foto);
        toolbar.setTitle("Portal de noticia");
        setSupportActionBar(toolbar);

        //Configuração Basica
        campotitulo = findViewById(R.id.nome_digital_portal_noticia);
        campodesc = findViewById(R.id.desc_digital_portal_noticia);
        campocontato = findViewById(R.id.desc_contato_portal_noticia);
        imagem1 = findViewById(R.id.imageLojaCadastro_noticia_f1);
        imagem1.setOnClickListener(this);
        imagem2 =findViewById(R.id.imageLojaCadastro_noticia_f2);
        imagem2.setOnClickListener(this);
        imagem3 = findViewById(R.id.imageLojaCadastro_noticia_f3);
        imagem3.setOnClickListener(this);
        imagem4 = findViewById(R.id.imageLojaCadastro_noticia_f4);
        imagem4.setOnClickListener(this);
        imagem5 = findViewById(R.id.imageLojaCadastro_noticia_f5);
        imagem5.setOnClickListener(this);
        imagem6 = findViewById(R.id.imageLojaCadastro_noticia_f6);
        imagem6.setOnClickListener(this);

        digital = new Categoria_portal_noticia();
        storageReference = ConfiguracaoFirebase.getFirebaseStorage();
        database = ConfiguracaoFirebase.getDatabase().getReference()
                .child("votacao").child("categorias").child("portal_noticia");
        databaseconta = ConfiguracaoFirebase.getDatabase().getReference().child("usuarios");
        identificadorUsuario = UsuarioFirebase.getIdentificadorUsuario();
        usuarioLogado = UsuarioFirebase.getDadosUsuarioLogado();
        botaosalvar = findViewById(R.id.botaosalvar_portal);
    ...
    public void  Salvar_Digital_Influence(){
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(novo_portal_de_noticia.this);
                ...
                taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        if(totalfotos==listaURLFotos.size()){
                            ...
                            digital.Salvar();
                            dialog.dismiss();
                            Toast toast = Toast.makeText(novo_portal_de_noticia.this, "Cadastrado com sucesso!", Toast.LENGTH_SHORT);
                            toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                            toast.show();
                            Intent it = new Intent(novo_portal_de_noticia.this,Lista_portal_noticia.class);
                            startActivity(it);
                            finish();
                        }
                    }
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        dialog.dismiss();
                        Toast.makeText(novo_portal_de_noticia.this, "Erro ao cadastrar", Toast.LENGTH_SHORT).show();
    ...
    private Categoria_portal_noticia configurar_categoria_influence(){
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case  R.id.imageLojaCadastro_noticia_f1:
                EscolherImagem(1);
                break;
            case  R.id.imageLojaCadastro_noticia_f2:
                EscolherImagem(2);
                break;
            case  R.id.imageLojaCadastro_noticia_f3:
                EscolherImagem(3);
                break;
            case  R.id.imageLojaCadastro_noticia_f4:
                EscolherImagem(4);
                break;
            case  R.id.imageLojaCadastro_noticia_f5:
                EscolherImagem(5);
                break;
            case  R.id.imageLojaCadastro_noticia_f6:
                EscolherImagem(6);
                break;

                case R.id.botaosalvar_portal:
                validarDados();
                break;
