...
public class Adapter_resultado_loja_virtual extends RecyclerView.Adapter<Adapter_resultado_loja_virtual.MyViewHolder> {

    private ArrayList<Categoria_loja_virtual> lista_digital;
    private Context context;

    public Adapter_resultado_loja_virtual(Context c, ArrayList<Categoria_loja_virtual> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_loja_virtual> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_loja_virtual getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_loja_virtual categoria_pessoa = lista_digital.get(position);
