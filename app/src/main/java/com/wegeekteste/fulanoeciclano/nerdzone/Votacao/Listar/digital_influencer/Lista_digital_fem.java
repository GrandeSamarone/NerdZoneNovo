...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Adapter_votacao.Adapter_categoria_pessoa_fem;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.digital_influencer.novo_digital_fem;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Detalhe.detalhe_votacao_fem;
...
public class Lista_digital_fem extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private Adapter_categoria_pessoa_fem adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        novo_influencer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent( Lista_digital_fem.this,novo_digital_fem.class);
                startActivity(it);
                finish();
            }
        });
        ...
        refresh = findViewById(R.id.refresh_digital_influenc_fem);
        ...
        recyclerView_lista_digital = findViewById(R.id.recycleview_digital_influence_fem);
        ...
        adapter = new Adapter_categoria_pessoa_fem(this,lista_digital_influence);
        ...
        recyclerView_lista_digital.addOnItemTouchListener(new RecyclerItemClickListener(this,
            ...
            public void onItemClick(View view, int position) {
                List<Categoria_pessoa_fem> listCategoriaAtualizado = adapter.getcategoria();

                if (listCategoriaAtualizado.size() > 0) {
                    Categoria_pessoa_fem categoriaselecionada = listCategoriaAtualizado.get(position);
                    Intent it = new Intent(Lista_digital_fem.this,detalhe_votacao_fem.class);
        ...
        ChildEventListenerperfil=database_usuario.orderByChild("id").equalTo(identificadorUsuario).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                icone.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent it = new Intent(Lista_digital_fem.this, MinhaConta.class);
                        startActivity(it);

                    }
                });
                Glide.with(Lista_digital_fem.this)
                        .load(iconeurl)
                        .into(icone);
