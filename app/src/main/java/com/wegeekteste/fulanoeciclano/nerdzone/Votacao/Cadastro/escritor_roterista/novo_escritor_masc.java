package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.escritor_roterista;
...
public class novo_escritor_masc extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_novo_escritor_masc);

        toolbar = findViewById(R.id.toolbarsecundario_sem_foto);
        toolbar.setTitle("novo_escritor");
        setSupportActionBar(toolbar);

        //Configuração Basica
        campotitulo = findViewById(R.id.nome_digital_escritor_masc);
        campodesc = findViewById(R.id.desc_digital_escritor_masc);
        campocontato = findViewById(R.id.desc_contato_escritor_masc);
        imagem1 = findViewById(R.id.imageLojaCadastro_escritor_masc_m1);
        imagem1.setOnClickListener(this);
        imagem2 =findViewById(R.id.imageLojaCadastro_escritor_masc_m2);
        imagem2.setOnClickListener(this);
        imagem3 = findViewById(R.id.imageLojaCadastro_escritor_masc_m3);
        imagem3.setOnClickListener(this);
        imagem4 = findViewById(R.id.imageLojaCadastro_escritor_masc_m4);
        imagem4.setOnClickListener(this);
        imagem5 = findViewById(R.id.imageLojaCadastro_escritor_masc_m5);
        imagem5.setOnClickListener(this);
        imagem6 = findViewById(R.id.imageLojaCadastro_escritor_masc_m6);
        imagem6.setOnClickListener(this);

        digital = new Categoria_escritor_masc();
        storageReference = ConfiguracaoFirebase.getFirebaseStorage();
        database = ConfiguracaoFirebase.getDatabase().getReference()
                .child("votacao").child("categorias").child("escritor_masc");
        databaseconta = ConfiguracaoFirebase.getDatabase().getReference().child("usuarios");
        identificadorUsuario = UsuarioFirebase.getIdentificadorUsuario();
        usuarioLogado = UsuarioFirebase.getDadosUsuarioLogado();
        botaosalvar = findViewById(R.id.botaosalvar_escritor_masc);
    ...
    public void  Salvar_Digital_Influence(){
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(novo_escritor_masc.this);
                ...
                taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        if(totalfotos==listaURLFotos.size()){
                            ...
                            digital.Salvar();
                            dialog.dismiss();
                            Toast toast = Toast.makeText(novo_escritor_masc.this, "Cadastrado com sucesso!", Toast.LENGTH_SHORT);
                            toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                            toast.show();
                            Intent it = new Intent(novo_escritor_masc.this,Lista_escritor.class);
                            startActivity(it);
                            finish();
                        }
                    }
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        dialog.dismiss();
                        Toast.makeText(novo_escritor_masc.this, "Erro ao cadastrar", Toast.LENGTH_SHORT).show();
    ...
    private Categoria_escritor_masc configurar_categoria_influence(){
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case  R.id.imageLojaCadastro_escritor_masc_m1:
                EscolherImagem(1);
                break;
            case  R.id.imageLojaCadastro_escritor_masc_m2:
                EscolherImagem(2);
                break;
            case  R.id.imageLojaCadastro_escritor_masc_m3:
                EscolherImagem(3);
                break;
            case  R.id.imageLojaCadastro_escritor_masc_m4:
                EscolherImagem(4);
                break;
            case  R.id.imageLojaCadastro_escritor_masc_m5:
                EscolherImagem(5);
                break;
            case  R.id.imageLojaCadastro_escritor_masc_m6:
                EscolherImagem(6);
                break;

            case R.id.botaosalvar_escritor_masc:
                validarDados();
                break;
