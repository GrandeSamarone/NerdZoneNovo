...
public class Adapter_reporter_fem extends RecyclerView.Adapter<Adapter_reporter_fem.MyViewHolder> {

    private ArrayList<Categoria_reporter_fem> lista_digital;
    private Context context;

    public Adapter_reporter_fem(Context c, ArrayList<Categoria_reporter_fem> categora){
        this.context=c;
