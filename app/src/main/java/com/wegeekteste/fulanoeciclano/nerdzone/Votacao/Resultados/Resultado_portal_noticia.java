...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Adapter_resultado.Adapter_resultado_portal_noticia;
...
public class Resultado_portal_noticia extends AppCompatActivity {

    private Toolbar toolbar;
    private FloatingActionButton novo_influencer;
    private FirebaseUser usuario;
    private Adapter_resultado_portal_noticia adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_portal_noticia);
        ...
        mDatabase_digital = ConfiguracaoFirebase.getFirebaseDatabase()
                .child("votacao").child("categorias").child("portal_noticia").orderByChild("votos");
        //recycleview
        recyclerViewresultado = findViewById(R.id.resultado_portal_noticia);
        //recyclerViewresultado.setHasFixedSize(true);
        mManager = new LinearLayoutManager(this);
        mManager.setReverseLayout(true);
        mManager.setStackFromEnd(true);
        recyclerViewresultado.setLayoutManager(mManager);
        adapter = new Adapter_resultado_portal_noticia(this, lista_digital_influence);
...
*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                Intent it = new Intent(Resultado_portal_noticia.this, Lista_portal_noticia.class);
                startActivity(it);
                finish();
                break;
    ...
    private void tela_finalizar() {
        android.app.AlertDialog.Builder msgbox = new android.app.AlertDialog.Builder(Resultado_portal_noticia.this);
