...
public class Adapter_resultado_escritor_masc extends RecyclerView.Adapter<Adapter_resultado_escritor_masc.MyViewHolder> {

    private ArrayList<Categoria_escritor_masc> lista_digital;
    private Context context;

    public Adapter_resultado_escritor_masc(Context c, ArrayList<Categoria_escritor_masc> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_escritor_masc> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_escritor_masc getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_escritor_masc categoria_pessoa = lista_digital.get(position);
