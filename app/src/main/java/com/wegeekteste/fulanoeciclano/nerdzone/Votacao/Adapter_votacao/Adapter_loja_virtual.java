...
public class Adapter_loja_virtual extends RecyclerView.Adapter<Adapter_loja_virtual.MyViewHolder> {

    private ArrayList<Categoria_loja_virtual> lista_digital;
    private Context context;

    public Adapter_loja_virtual(Context c, ArrayList<Categoria_loja_virtual> categora){
        this.context=c;
