package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Listar.kpop;
...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Adapter_votacao.Adapter_kpop_masc;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.kpop.novo_kpop_masc;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Detalhe.Detalhe_kpop_masc;
...
public class Lista_kpop_masc extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private Adapter_kpop_masc adapter;
    ...
    private ArrayList<Categoria_kpop_masc> lista_digital_influence = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_kpop);

        toolbar = findViewById(R.id.toolbarsecundario);
        toolbar.setTitle("Kpop Masculino");
        setSupportActionBar(toolbar);

        //Configuracoes Originais
        linear_nada_cadastrado=findViewById(R.id.linear_nada_cadastrado_kpop_masc);
        novo_influencer = findViewById(R.id.buton_novo_kpop_masc);
        novo_influencer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent( Lista_kpop_masc.this,novo_kpop_masc.class);
                startActivity(it);
                finish();
            }
        });
        ...
        refresh = findViewById(R.id.refresh_kpop_masc);
        ...
        recyclerView_lista_digital = findViewById(R.id.recycleview_kpop_masc);
        ...
        adapter = new Adapter_kpop_masc(this,lista_digital_influence);
        ...
        recyclerView_lista_digital.addOnItemTouchListener(new RecyclerItemClickListener(this,
            ...
            public void onItemClick(View view, int position) {
                List<Categoria_kpop_masc> listCategoriaAtualizado = adapter.getcategoria();

                if (listCategoriaAtualizado.size() > 0) {
                    Categoria_kpop_masc categoriaselecionada = listCategoriaAtualizado.get(position);
                    Intent it = new Intent(Lista_kpop_masc.this,Detalhe_kpop_masc.class);
      ...
      linear_nada_cadastrado.setVisibility(View.VISIBLE);
        ...
        valuedigitalListener = mDatabase_digital.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                Categoria_kpop_masc cat = dataSnapshot.getValue(Categoria_kpop_masc.class);
        ...
        ChildEventListenerperfil=database_usuario.orderByChild("id").equalTo(identificadorUsuario).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                icone.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent it = new Intent(Lista_kpop_masc.this, MinhaConta.class);
                        startActivity(it);

                    }
                });
                Glide.with(Lista_kpop_masc.this)
                        .load(iconeurl)
                        .into(icone);
