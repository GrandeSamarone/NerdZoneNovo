...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Resultados.Resultado_loja_virtual;
...
public class Detalhe_Loja_virtual extends AppCompatActivity {
    ...
    private Categoria_loja_virtual categoriaselecionado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalhe__loja_virtual);

        toolbar = findViewById(R.id.toolbar_detalhe_loja);
        ...
        fotos = findViewById(R.id.carousel_foto_selecionada_loja);
        perfil = findViewById(R.id.icone_author_selecionado_loja);
        titulo = findViewById(R.id.detalhe_selecionado_loja_titulo);
        toolbar_texto = findViewById(R.id.texto_Toolbar_loja);
        criador = findViewById(R.id.detalhe_selecionado_loja_author);
        descricao = findViewById(R.id.detalhe_selecionad_loja_descricao);
        click = findViewById(R.id.click_layout);

        categoriaselecionado = (Categoria_loja_virtual) getIntent().getSerializableExtra("categoria_selecionada");

        if(categoriaselecionado!=null){
            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(this);
            builder.setCancelable(false);
            LayoutInflater layoutInflater = LayoutInflater.from(Detalhe_Loja_virtual.this);
            ...
            fotos.setImageClickListener(new ImageClickListener() {
                ...
                public void onClick(int position) {
                    ...
                    */
                    ...
                    Intent it = new Intent(Detalhe_Loja_virtual.this, AbrirImagemComercio.class);
                        ...
                        if (!identificadorUsuario.equals(user.getId())) {
                            click.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent it = new Intent(Detalhe_Loja_virtual.this, Perfil.class);
                            ...
                            click.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    Intent it = new Intent(Detalhe_Loja_virtual.this, MinhaConta.class);
                                    it.putExtra("id", user.getId());
                                    startActivity(it);
                                }
                            });
    ...
    private void ValidarVoto() {
        ...
        mDatabasecategoria.child(categoriaselecionado.getId()).updateChildren(dados).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                dialog.dismiss();
                Toast toast = Toast.makeText(Detalhe_Loja_virtual.this, "Voto confirmado com sucesso!",Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                toast.show();
                Intent it = new Intent(Detalhe_Loja_virtual.this, Resultado_loja_virtual.class);
                startActivity(it);
                finish();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                dialog.dismiss();
                Toast toast = Toast.makeText(Detalhe_Loja_virtual.this, "Ocorreu um erro, tente novamente ou verifique sua conexão"
                        ,Toast.LENGTH_LONG);
                toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                toast.show();
            }
