...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Adapter_votacao.Adapter_kpop_fem;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.kpop.novo_kpop_fem;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Detalhe.Detalhe_kpop_fem;
...
public class Lista_kpop_fem extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private Adapter_kpop_fem adapter;
    ...
    private ArrayList<Categoria_kpop_fem> lista_digital_influence = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_kpop_fem);
        toolbar = findViewById(R.id.toolbarsecundario);
        toolbar.setTitle("Kpop Feminino");
        setSupportActionBar(toolbar);

        //Configuracoes Originais
        linear_nada_cadastrado=findViewById(R.id.linear_nada_cadastrado_kpop_fem);
        novo_influencer = findViewById(R.id.buton_novo_kpop_fem);
        novo_influencer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent( Lista_kpop_fem.this,novo_kpop_fem.class);
                startActivity(it);
                finish();
            }
        });
        ...
        refresh = findViewById(R.id.refresh_kpop_fem);
        ...
        recyclerView_lista_digital = findViewById(R.id.recycleview_kpop_fem);
        ...
        adapter = new Adapter_kpop_fem(this,lista_digital_influence);
        ...
        recyclerView_lista_digital.addOnItemTouchListener(new RecyclerItemClickListener(this,
            ...
            public void onItemClick(View view, int position) {
                List<Categoria_kpop_fem> listCategoriaAtualizado = adapter.getcategoria();

                if (listCategoriaAtualizado.size() > 0) {
                    Categoria_kpop_fem categoriaselecionada = listCategoriaAtualizado.get(position);
                    Intent it = new Intent(Lista_kpop_fem.this,Detalhe_kpop_fem.class);
       ...
       linear_nada_cadastrado.setVisibility(View.VISIBLE);
        ...
        valuedigitalListener = mDatabase_digital.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                Categoria_kpop_fem cat = dataSnapshot.getValue(Categoria_kpop_fem.class);
        ...
        ChildEventListenerperfil=database_usuario.orderByChild("id").equalTo(identificadorUsuario).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                icone.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent it = new Intent(Lista_kpop_fem.this, MinhaConta.class);
                        startActivity(it);
                    }
                });
                Glide.with(Lista_kpop_fem.this)
                        .load(iconeurl)
                        .into(icone);
