...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Resultados.Resultado_espaco_geek;
...
public class Detalhe_espaco_geek extends AppCompatActivity {
    ...
    private Categoria_espaco_geek categoriaselecionado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalhe_espaco_geek);

        toolbar = findViewById(R.id.toolbar_detalhe_espaco);
        ...
        fotos = findViewById(R.id.carousel_foto_selecionada_espaco);
        perfil = findViewById(R.id.icone_author_selecionado_espaco);
        titulo = findViewById(R.id.detalhe_selecionado_espaco_titulo);
        toolbar_texto = findViewById(R.id.texto_Toolbar_espaco);
        criador = findViewById(R.id.detalhe_selecionado_espaco_author);
        descricao = findViewById(R.id.detalhe_selecionad_espaco_descricao);
        click = findViewById(R.id.click_layout);

        categoriaselecionado = (Categoria_espaco_geek) getIntent().getSerializableExtra("categoria_selecionada");

        if(categoriaselecionado!=null){
            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(this);
            builder.setCancelable(false);
            LayoutInflater layoutInflater = LayoutInflater.from(Detalhe_espaco_geek.this);
            ...
            fotos.setImageClickListener(new ImageClickListener() {
                ...
                public void onClick(int position) {
                    ...
                    */
                    ...
                    Intent it = new Intent(Detalhe_espaco_geek.this, AbrirImagemComercio.class);
                        ...
                        if (!identificadorUsuario.equals(user.getId())) {
                            click.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent it = new Intent(Detalhe_espaco_geek.this, Perfil.class);
                            ...
                            click.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    Intent it = new Intent(Detalhe_espaco_geek.this, MinhaConta.class);
                                    it.putExtra("id", user.getId());
                                    startActivity(it);
                                }
                            });
    ...
    private void ValidarVoto() {
        ...
        mDatabasecategoria.child(categoriaselecionado.getId()).updateChildren(dados).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                dialog.dismiss();
                Toast toast = Toast.makeText(Detalhe_espaco_geek.this, "Voto confirmado com sucesso!",Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                toast.show();
                Intent it = new Intent(Detalhe_espaco_geek.this, Resultado_espaco_geek.class);
                startActivity(it);
                finish();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                dialog.dismiss();
                Toast toast = Toast.makeText(Detalhe_espaco_geek.this, "Ocorreu um erro, tente novamente ou verifique sua conexão"
                        ,Toast.LENGTH_LONG);
                toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                toast.show();
            }
