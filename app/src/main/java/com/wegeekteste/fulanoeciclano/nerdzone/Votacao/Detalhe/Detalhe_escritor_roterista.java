...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Resultados.Resultado_escritor_masc;
...
public class Detalhe_escritor_roterista extends AppCompatActivity {
    ...
    private Categoria_escritor_masc categoriaselecionado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalhe_escritor_roterista);

        toolbar = findViewById(R.id.toolbar_detalhe_escritor_masc  );
        ...
        fotos = findViewById(R.id.carousel_foto_selecionada_escritor_masc);
        perfil = findViewById(R.id.icone_author_selecionado_escritor_masc);
        titulo = findViewById(R.id.detalhe_selecionado_escritor_masc_titulo);
        toolbar_texto = findViewById(R.id.texto_Toolbar_escritor_masc);
        criador = findViewById(R.id.detalhe_selecionado_escritor_masc_criador);
        descricao = findViewById(R.id.detalhe_selecionad_escritor_masc_descricao);
            ...
            fotos.setImageClickListener(new ImageClickListener() {
                ...
                public void onClick(int position) {
                    ...
                    */
                    ...
                    Intent it = new Intent(Detalhe_escritor_roterista.this, AbrirImagemComercio.class);
        ...
        ChildEventListeneruser = database_usuario.orderByChild("id")
                .equalTo(idusuario).addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        ...
                        Glide.with(Detalhe_escritor_roterista.this)
                                .load(foto)
                                .into(perfil);
                        ...
                        if (!identificadorUsuario.equals(user.getId())) {
                            click.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent it = new Intent(Detalhe_escritor_roterista.this, Perfil.class);
                            ...
                            click.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    Intent it = new Intent(Detalhe_escritor_roterista.this, MinhaConta.class);
                                    it.putExtra("id", user.getId());
                                    startActivity(it);
                                }
                            });
    ...
    private void ValidarVoto() {
        ...
        mDatabasecategoria.child(categoriaselecionado.getId()).updateChildren(dados).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                dialog.dismiss();
                Toast toast = Toast.makeText(Detalhe_escritor_roterista.this, "Voto confirmado com sucesso!",Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                toast.show();
                Intent it = new Intent(Detalhe_escritor_roterista.this, Resultado_escritor_masc.class);
                startActivity(it);
                finish();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                dialog.dismiss();
                Toast toast = Toast.makeText(Detalhe_escritor_roterista.this, "Ocorreu um erro, tente novamente ou verifique sua conexão"
                        ,Toast.LENGTH_LONG);
                toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                toast.show();
            }
