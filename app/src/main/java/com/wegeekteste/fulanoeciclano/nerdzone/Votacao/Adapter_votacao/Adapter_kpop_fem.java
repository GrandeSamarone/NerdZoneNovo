...
public class Adapter_kpop_fem extends RecyclerView.Adapter<Adapter_kpop_fem.MyViewHolder> {

    private ArrayList<Categoria_kpop_fem> lista_digital;
    private Context context;

    public Adapter_kpop_fem(Context c, ArrayList<Categoria_kpop_fem> categora){
        this.context=c;
