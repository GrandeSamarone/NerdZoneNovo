package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.livro_quadrinho;
...
public class novo_livro_quadrinho extends AppCompatActivity implements View.OnClickListener {
    ...
    private Categoria_livro_quadrinho digital;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_novo_livro_quadrinho);


        toolbar = findViewById(R.id.toolbarsecundario_sem_foto);
        toolbar.setTitle("Novo Livro Quadrinho");
        setSupportActionBar(toolbar);

        //Configuração Basica
        campotitulo = findViewById(R.id.nome__livro_quad);
        campodesc = findViewById(R.id.desc_livro_quad);
        campocontato = findViewById(R.id.desc_contato_livro_quad);
        imagem1 = findViewById(R.id.imageLojaCadastro_livro_quad_m1);
        imagem1.setOnClickListener(this);
        imagem2 =findViewById(R.id.imageLojaCadastro_livro_quad_m2);
        imagem2.setOnClickListener(this);
        imagem3 = findViewById(R.id.imageLojaCadastro_livro_quad_m3);
        imagem3.setOnClickListener(this);
        imagem4 = findViewById(R.id.imageLojaCadastro_livro_quad_m4);
        imagem4.setOnClickListener(this);
        imagem5 = findViewById(R.id.imageLojaCadastro_livro_quad_m5);
        imagem5.setOnClickListener(this);
        imagem6 = findViewById(R.id.imageLojaCadastro_livro_quad_m6);
        imagem6.setOnClickListener(this);

        digital = new Categoria_livro_quadrinho();
        ...
        botaosalvar = findViewById(R.id.botaosalvar_livro_quad);
    ...
    public void  Salvar_Digital_Influence(){
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(novo_livro_quadrinho.this);
                ...
                taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        if(totalfotos==listaURLFotos.size()){
                            ...
                            digital.Salvar();
                            dialog.dismiss();
                            Toast toast = Toast.makeText(novo_livro_quadrinho.this, "Cadastrado com sucesso!", Toast.LENGTH_SHORT);
                            toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL, 0, 0);
                            toast.show();
                            Intent it = new Intent(novo_livro_quadrinho.this,Lista_livro_quadrinho.class);
                            startActivity(it);
                            finish();
                        }
                    }
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        dialog.dismiss();
                        Toast.makeText(novo_livro_quadrinho.this, "Erro ao cadastrar", Toast.LENGTH_SHORT).show();
    ...
    private Categoria_livro_quadrinho configurar_categoria_influence(){
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case  R.id.imageLojaCadastro_livro_quad_m1:
                EscolherImagem(1);
                break;
            case  R.id.imageLojaCadastro_livro_quad_m2:
                EscolherImagem(2);
                break;
            case  R.id.imageLojaCadastro_livro_quad_m3:
                EscolherImagem(3);
                break;
            case  R.id.imageLojaCadastro_livro_quad_m4:
                EscolherImagem(4);
                break;
            case  R.id.imageLojaCadastro_livro_quad_m5:
                EscolherImagem(5);
                break;
            case  R.id.imageLojaCadastro_livro_quad_m6:
                EscolherImagem(6);
                break;

            case R.id.botaosalvar_livro_quad:
                validarDados();
                break;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                Intent it = new Intent(novo_livro_quadrinho.this, Lista_digital_masc.class);
                startActivity(it);
