...
public class Adapter_resultado_empreendedora_fem extends RecyclerView.Adapter<Adapter_resultado_empreendedora_fem.MyViewHolder> {

    private ArrayList<Categoria_empreendedora> lista_digital;
    private Context context;

    public Adapter_resultado_empreendedora_fem(Context c, ArrayList<Categoria_empreendedora> categora){
        this.context=c;
    ...
    public Categoria_empreendedora getItem(int position)
