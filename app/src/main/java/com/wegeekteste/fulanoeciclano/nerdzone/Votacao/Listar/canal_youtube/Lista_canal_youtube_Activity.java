package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Listar.canal_youtube;
...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Adapter_votacao.Adapter_Canal_do_youtube;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.canal_do_youtube.Novo_canal_youtube;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Detalhe.Detalhe_canal_youtube;
...
public class Lista_canal_youtube_Activity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private Adapter_Canal_do_youtube adapter;
    ...
    private ArrayList<Categoria_youtube> lista_digital_influence = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        novo_influencer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent( Lista_canal_youtube_Activity.this,Novo_canal_youtube.class);
                startActivity(it);
                finish();
            }
        });
        ...
        refresh = findViewById(R.id.refresh_canal_youtube);
        ...
        recyclerView_lista_digital = findViewById(R.id.recycleview_canal_youtube);
        ...
        adapter = new Adapter_Canal_do_youtube(this,lista_digital_influence);
        ...
        recyclerView_lista_digital.addOnItemTouchListener(new RecyclerItemClickListener(this,
            ...
            public void onItemClick(View view, int position) {
                List<Categoria_youtube> listCategoriaAtualizado = adapter.getcategoria();

                if (listCategoriaAtualizado.size() > 0) {
                    Categoria_youtube categoriaselecionada = listCategoriaAtualizado.get(position);
                    Intent it = new Intent(Lista_canal_youtube_Activity.this,Detalhe_canal_youtube.class);
        ...
        ChildEventListenerperfil=database_usuario.orderByChild("id").equalTo(identificadorUsuario).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                icone.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent it = new Intent(Lista_canal_youtube_Activity.this, MinhaConta.class);
                        startActivity(it);

                    }
                });
                Glide.with(Lista_canal_youtube_Activity.this)
                        .load(iconeurl)
                        .into(icone);
