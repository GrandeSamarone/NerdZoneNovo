...
public class Adapter_resultado_youtuber_masc extends RecyclerView.Adapter<Adapter_resultado_youtuber_masc.MyViewHolder> {

    private ArrayList<Categoria_youtuber_masc> lista_digital;
    private Context context;

    public Adapter_resultado_youtuber_masc(Context c, ArrayList<Categoria_youtuber_masc> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_youtuber_masc> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_youtuber_masc getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_youtuber_masc categoria_pessoa = lista_digital.get(position);
