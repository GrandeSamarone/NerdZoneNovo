...
public class Adapter_resultado_escritora_fem extends RecyclerView.Adapter<Adapter_resultado_escritora_fem.MyViewHolder> {

    private ArrayList<Categoria_escritor_fem> lista_digital;
    private Context context;

    public Adapter_resultado_escritora_fem(Context c, ArrayList<Categoria_escritor_fem> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_escritor_fem> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_escritor_fem getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_escritor_fem categoria_pessoa = lista_digital.get(position);
