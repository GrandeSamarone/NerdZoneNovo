...
public class Adapter_resultado_cosplay_fem extends RecyclerView.Adapter<Adapter_resultado_cosplay_fem.MyViewHolder> {

    private ArrayList<Categoria_cosplay_fem> lista_digital;
    private Context context;

    public Adapter_resultado_cosplay_fem(Context c, ArrayList<Categoria_cosplay_fem> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_cosplay_fem> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_cosplay_fem getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_cosplay_fem categoria_pessoa = lista_digital.get(position);
