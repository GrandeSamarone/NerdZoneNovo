...
package com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Listar.youtuber;
...
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Adapter_votacao.Adapter_youtuber_fem;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Cadastro.youtuber.novo_youtuber_fem;
import com.wegeekteste.fulanoeciclano.nerdzone.Votacao.Detalhe.Detalhe_youtube_fem;
...
public class Lista_youtuber_fem extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private Adapter_youtuber_fem adapter;
    ...
    private ArrayList<Categoria_youtuber_fem> lista_digital_influence = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_youtuber_fem);
        toolbar = findViewById(R.id.toolbarsecundario);
        toolbar.setTitle("Youtuber Feminino");
        setSupportActionBar(toolbar);

        //Configuracoes Originais
        linear_nada_cadastrado= findViewById(R.id.linear_nada_cadastrado_youtube_fem);
        novo_influencer = findViewById(R.id.buton_novo_youtuber_fem);
        novo_influencer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent( Lista_youtuber_fem.this,novo_youtuber_fem.class);
                startActivity(it);
                finish();
            }
        });
        ...
        refresh = findViewById(R.id.refresh_youtube_fem);
        ...
        recyclerView_lista_digital = findViewById(R.id.recycleview_yotuber_fem);
        ...
        adapter = new Adapter_youtuber_fem(this,lista_digital_influence);
        ...
        recyclerView_lista_digital.addOnItemTouchListener(new RecyclerItemClickListener(this,
            ...
            public void onItemClick(View view, int position) {
                List<Categoria_youtuber_fem> listCategoriaAtualizado = adapter.getcategoria();

                if (listCategoriaAtualizado.size() > 0) {
                    Categoria_youtuber_fem categoriaselecionada = listCategoriaAtualizado.get(position);
                    Intent it = new Intent(Lista_youtuber_fem.this,Detalhe_youtube_fem.class);
    ...
    private void RecuperarLista_digital_masc(){
        ...
        valuedigitalListener = mDatabase_digital.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                Categoria_youtuber_fem cat = dataSnapshot.getValue(Categoria_youtuber_fem.class);
        ...
        ChildEventListenerperfil=database_usuario.orderByChild("id").equalTo(identificadorUsuario).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                icone.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent it = new Intent(Lista_youtuber_fem.this, MinhaConta.class);
                        startActivity(it);

                    }
                });
                Glide.with(Lista_youtuber_fem.this)
                        .load(iconeurl)
                        .into(icone);
