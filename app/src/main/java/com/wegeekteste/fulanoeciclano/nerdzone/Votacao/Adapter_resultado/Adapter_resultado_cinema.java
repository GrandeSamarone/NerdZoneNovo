...
public class Adapter_resultado_cinema extends RecyclerView.Adapter<Adapter_resultado_cinema.MyViewHolder> {

    private ArrayList<Categoria_cinema> lista_digital;
    private Context context;

    public Adapter_resultado_cinema(Context c, ArrayList<Categoria_cinema> categora){
        this.context=c;
        this.lista_digital=categora;
    }

    public List<Categoria_cinema> getcategoria(){
        return this.lista_digital;
    }

    public Categoria_cinema getItem(int position)
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Categoria_cinema categoria_pessoa = lista_digital.get(position);
