...
public class Adapter_escritor_masc extends RecyclerView.Adapter<Adapter_escritor_masc.MyViewHolder> {

    private ArrayList<Categoria_escritor_masc> lista_digital;
    private Context context;

    public Adapter_escritor_masc(Context c, ArrayList<Categoria_escritor_masc> categora){
        this.context=c;
