...
public class Adapter_Canal_do_youtube extends RecyclerView.Adapter<Adapter_Canal_do_youtube.MyViewHolder> {

    private ArrayList<Categoria_youtube> lista_digital;
    private Context context;

    public Adapter_Canal_do_youtube(Context c, ArrayList<Categoria_youtube> categora){
        this.context=c;
